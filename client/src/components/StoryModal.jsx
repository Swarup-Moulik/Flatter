            ...
            <div className='w-full max-w-md'>
                ...
                <div className='flex gap-2 mt-4'>
                    ...
                    'bg-white text-black' : 'bg-zinc-800'} cursor-pointer`}>
                        <input type="file" accept='image/*, video/*' className='hidden' onChange={(e)=>{handleMediaUpload(e); 
                            setMode('media')}}/>
                ...
                })} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r
                from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer'>
